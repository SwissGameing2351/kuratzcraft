...
mobs:register_mob("mobs_npc:npc", {
	...
	drops = {
		...
		{name = "mobs:meat_raw", chance = 6, min = 1, max = 2},
		{name = "nokia:c201", chance = 7, min = 1, max = 1},
		{name = "nokia:c201_dead", chance = 4, min = 1, max = 1},
		{name = "nokia:c201_lowbattery", chance = 6, min = 1, max = 1},
		{name = "bones:bones", chance = 1, min = 1, max = 1},
		{name = "nokia:battery1", chance = 9, min = 1, max = 1},
		{name = "default:torch", chance = 5, min = 1, max = 4},
		{name = "tnt:tnt_stick", chance = 9, min = 1, max = 3}
	},
	water_damage = 0,
	lava_damage = 2,
	light_damage = 0,
